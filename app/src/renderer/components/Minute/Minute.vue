<template>
    <div style="height: 100%; overflow: hidden;">
        ...
        <div class=" ui fixed-head">
            <div class="ui form">
                <div class="field">
                <textarea rows="2" :disabled="filename == null ? true : false" v-model="minute" @keyup.alt.69="editLastMinute"
            ...
            <div class="ui  grid" style="height: 100%;">
                <div class="ten wide column"
                    ...
                    <div style="height: 100%; overflow-y: scroll; padding-bottom: 80px;  ">
                        ...
                        <p v-if="filename == null" style="text-align: center;">Please Open an existing or create a new minutes file to start </p>
